...
export default function LibraryExercisesPage() {
  ...
  function handleCreate(kind: ExerciseKind) {
    if (kind === "vocabulary") {
      ...
      // Teacher enters questions/answers and uploads the MP3 directly in the
      // exercise editor — no separate Material has to exist beforehand.
      const material = createListeningMaterial("Audio bài nghe");
      const e = createListeningExercise("Listening Exercise chưa đặt tên", material.id);
